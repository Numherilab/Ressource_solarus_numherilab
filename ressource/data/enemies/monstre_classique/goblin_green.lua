...
function enemy:set_weapon(weapon_name)
  ...
  if weapon ~= "slingshot" then
    sprite = self:create_sprite("enemies/monstre_classique/goblin_green")
  end
  ...
  elseif weapon_name == "slingshot" then
    -- Replace main sprite.
    has_weapon, has_throwable_weapon = true, true
    sprite = self:create_sprite("enemies/monstre_classique/goblin_green_slingshot")    
  end
  if weapon_name == "club" or weapon_name == "axe" then
    weapon_sprite = enemy:create_sprite("enemies/monstre_classique/goblin_" .. weapon)
