...
function enemy:on_created()
  self:set_life(2)
  self:set_damage(2)
  self:create_sprite("enemies/monstres_de_pierre/armos_big")
  self:set_invincible()
  ...
  self:set_attack_consequence("arrow", "protected") -- Ajout de cette ligne
end

function enemy:on_restarted()
  -- Start throwing beam particles.
  local properties = {particle_sprite = particle_sprite, damage = damage, breed = "projectile/beam_particle"}
