...
function enemy:on_created()
  ...
  self:set_life(12)
  self:set_damage(4)
  eye_sprite = self:create_sprite("enemies/boss/flora_gohma/flora_gohma_eye")
  arms_sprite = self:create_sprite("enemies/boss/flora_gohma/flora_gohma_eye")
  ...
  -- create the petals
  for i = 1, 5 do
    petals[i].sprite = self:create_sprite("enemies/boss/flora_gohma/flora_gohma_eye")
    petals[i].life = 3
...
function enemy:repeat_create_son()
  ...
  if self:get_map():get_entities_count(son_prefix) < 10 then
    ...
    local son = self:create_enemy{
      name = son_name,
      breed = "boss/flora_gohma/snap_dragon",
      layer = layer
    }
