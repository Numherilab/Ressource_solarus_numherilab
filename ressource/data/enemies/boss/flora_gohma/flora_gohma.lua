...
function enemy:on_created()
  ...
  self:create_sprite("enemies/boss/flora_gohma/flora_gohma")
  self:set_size(80, 80)
  ...
  ball_sprite = sol.sprite.create("enemies/boss/flora_gohma/flora_gohma_eye")
...
function enemy:on_enabled()
  ...
  if eye == nil then
    ...
    eye = self:create_enemy{
      name = my_name .. "_eye",
      breed = "boss/flora_gohma/flora_gohma_eye",
      x = 0,
      y = -112
    }
    eye.body = self
