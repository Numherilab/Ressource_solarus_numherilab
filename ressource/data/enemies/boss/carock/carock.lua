...
local positions = {
  {x = 56, y = 48, direction4 = 3},
  {x = 160, y = 48, direction4 = 3},
  {x = 272, y = 48, direction4 = 3},
  {x = 272, y = 184, direction4 = 1},
  {x = 56, y = 200, direction4 = 1}
}
...
function enemy:on_created()
  ...
  local sprite = self:create_sprite("enemies/boss/carock/carock")
...
function enemy:fire_step_3()
  ...
  if sprite:get_animation() == "arms_out" then
    sound = "boss_fireball"
    breed = "projectile/fireball_triple"
  end
  sprite:set_animation("stopped")
  ...
  function throw_fire()
    ...
    self:create_enemy({x = 0, y = 21, breed = "projectile/fireball_triple", name = "carock_fireball_" .. nb_sons_created})
  end
...
function enemy:end_dialog()
  ...
  if not game:get_value("b1240") then -- This dialog hasn't been heard before.
    ...
    self:get_game():start_dialog("defeat", function()
