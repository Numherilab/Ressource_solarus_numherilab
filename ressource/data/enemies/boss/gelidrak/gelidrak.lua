...
function enemy:on_created()
  ...
  self:create_sprite("enemies/boss/gelidrak/gelidrak")
  ...
  tail_ball_sprite = sol.sprite.create("enemies/boss/gelidrak/gelidrak")
...
function enemy:on_enabled()
  ...
  if head == nil then
    ...
    head = self:create_enemy{
      name = my_name .. "_head",
      breed = "boss/gelidrak/gelidrak_head",
      x = 0,
      y = 48,
    }
    head_ball_sprite = sol.sprite.create("enemies/boss/gelidrak/gelidrak")
    ...
    tail = self:create_enemy{
      name = my_name .. "_tail",
      breed = "boss/gelidrak/gelidrak_tail",
      x = 0,
      y = -112,
    }
  end
