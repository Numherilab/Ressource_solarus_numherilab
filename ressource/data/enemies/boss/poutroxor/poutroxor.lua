...
function enemy:on_created()
  ...
  bird = self:create_sprite("enemies/boss/poutroxor/poutroxor")
  head = self:create_sprite("enemies/boss/poutroxor/poutroxor_head")
  skeleton = self:create_sprite("enemies/boss/poutroxor/poutroxor_skeleton")
  self:set_size(16, 16)
  self:set_origin(8, 8)
...
function enemy:skeleton_attack()
  ...
  sol.timer.start(self, 500, function()
    ...
    local son = self:create_enemy{
      name = son_name,
      breed = "boss/poutroxor/blue_flame",
      x = 0,
      y = -48,
      layer = 2,
    }
