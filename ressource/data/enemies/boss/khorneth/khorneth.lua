...
-- Sprites.
local main_sprite = enemy:create_sprite("enemies/boss/khorneth/khorneth")
local left_blade_sprite = enemy:create_sprite("enemies/boss/khorneth/khorneth_left_blade")
local right_blade_sprite = enemy:create_sprite("enemies/boss/khorneth/khorneth_right_blade")
