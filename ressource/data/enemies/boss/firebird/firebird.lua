...
function enemy:on_created()
  ...
  main_sprite = self:create_sprite("enemies/boss/firebird/firebird")
  claw_sprite = self:create_sprite("enemies/boss/firebird/firebird")
