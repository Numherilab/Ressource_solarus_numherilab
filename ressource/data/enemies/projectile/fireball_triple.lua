...
function enemy:on_created()
  ...
  self:create_sprite("enemies/projectile/fireball_triple")
  ...
  sprite2 = sol.sprite.create("enemies/projectile/fireball_triple")
  sprite2:set_animation("small")
  sprite3 = sol.sprite.create("enemies/projectile/fireball_triple")
...
function enemy:on_pre_draw()
  ...
  self:get_map():draw_visual(sprite2, x2, y2)
  self:get_map():draw_visual(sprite3, x3, y3)
end
